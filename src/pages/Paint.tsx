      ...
      <div className="w-[543px] h-[671px] mr-5 ml-9 rounded-2xl bg-[#F5F5F5]">
        <div className="mt-[39px] ml-[49px]">
          <div className="flex text-[28px]">
            <div className="font-FoundryMonoline-bold">
              From "{nft.collection}"
            </div>
            <img src={checkIcon} className="w-[18.9px] h-[18.9px] mt-3 ml-2 " />
          </div>
          <div className="mt-6">
            <div className="text-[40px] font-FoundryMonoline-bold">
              {nft.name}
            </div>
            <div className="flex">
              <div className="text-[24px] font-FoundryMonoline-bold">
                Royalities
              </div>
              <div className="text-[20px] mt-1 ml-2 bg-[#93D39B] rounded-lg w-[73px] h-[30px] pl-4">
                2.5%
              </div>
            </div>
        ...
        <div className="bg-[#0C0C0C] shadow mt-12 rounded-full w-[421px] flex justify-center h-[70px] ml-14">
          <button onClick={handlePurchase}>
            <div className="text-[#F8F8F8] text-[34px] font-FoundryMonoline-bold">
              Submit Purchase
            </div>
          </button>
        </div>
