      ...
      <div className="flex w-full items-center">
        ...
        <div className="flex items-center justify-start bg-[#F5F5F5] rounded-[40px] h-10 w-[30rem] ml-6 mr-auto ">
          ...
          <input
            ...
            className="w-full outline-none bg-transparent py-2.5 font-normal text-sm"
          />
        </div>
      </div>
      <button className="bg-black hover:bg-neutral-900 text-white rounded-[40px] h-12  w-auto md:p-0 px-16 mt-2 md:w-44 text-sm ml-[17rem] md:mx-16 ">
        Connect Wallet
      </button>
    </header>
  );
